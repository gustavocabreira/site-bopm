...
const SELECT_COLUMNS =
  "id, discord_user_id, discord_user_name, prefixo, chefe_equipe, motorista, homem3, homem4, local, veiculo, natureza, relato, artigos, data, horario, texto, individuos, materiais, created_at";
